//! Build script for phase_confluence WASM module
//!
...
fn main() {
    ...
    if !target.contains("wasm32") {
        ...
        println!(
            "cargo:warning=Building phase_confluence for non-WASM target: {}",
            target
        );
    } else {
    ...
    println!("cargo:rustc-env=PHASE_CONFLUENCE_VERSION={}", version);
}
